...
\begin{description}
\item[Code de départ associé :] \url{https://github.com/DistributedComputing/TP-transactions}.
\end{description}
...
Récupérez le code de départ dans le dépôt \href{https://github.com/DistributedComputing/TP-transactions}{GitHub}.
