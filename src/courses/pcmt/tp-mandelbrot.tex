...
\begin{description}
\item[Code de départ associé :] \url{https://github.com/DistributedComputing/TP-mandelbrot}.
\end{description}
...
Le code de départ est disponible sur le dépôt
\href{https://github.com/DistributedComputing/TP-mandelbrot}{GitHub} du TP.
