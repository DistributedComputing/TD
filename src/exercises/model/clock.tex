...
\begin{exercice}[Horloges logiques de Lamport]
  ...
  \Question{Donnez l'ordre partiel happens before sur les pas d'émission des messages.}
  \Question{Donnez l'horloge de Lamport associée à chacun des pas.}
  \Question{Donnez l'ordre partiel sur les messages associé à ces horloges.}
  \Question{Donnez un ordre total compatible avec ces horloges.}
